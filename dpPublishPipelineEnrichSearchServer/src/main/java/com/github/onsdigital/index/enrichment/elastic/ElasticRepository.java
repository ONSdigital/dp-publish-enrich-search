...
public class ElasticRepository {
    ...
    public Page loadData(String id, String index, String type) throws ElasticSearchException {
        Page document = null;
    ...
    public Page loadPage(String id, String index) throws EnrichServiceException {
